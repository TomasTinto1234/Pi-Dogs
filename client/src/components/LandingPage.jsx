...
export default function LandingPage(){
    return (
        <div className="fondo">
          ...
          <a  href="https://www.instagram.com/tomas_tinto/" target="_blank" className="ri-instagram-line icon">
            <img
		...
		<div className="dog">
			...
			<div>
            <Link to= "/home">
                <button className="select" type='image'>Home</button>
            </Link>
			</div>
        </div>
