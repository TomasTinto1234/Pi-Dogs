...
import { createDog, getTemperaments, clean } from "../actions";
...
function validate(input) {
  ...
  if (!input.image) {
    errors.image = "la imagen tiene que ser completada";
  }
  //   if (!input.temperaments) {
  //     errors.temperaments = "completa los temperamentos";
  //   }
  if (!input.life_span) {
        ...
        <form onSubmit={(e) => handleSubmit(e)}>
          <div>
            ...
            <select
              ...
              required
            >
              <option hidden={true}>Temperamentos</option>
              {temperaments.map((e) => (
